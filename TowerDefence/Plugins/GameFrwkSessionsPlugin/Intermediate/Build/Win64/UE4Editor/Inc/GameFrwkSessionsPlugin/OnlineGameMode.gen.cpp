...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AOnlineGameMode_Statics::ClassParams = {
		...
		0,
		0x008802ACu,
		METADATA_PARAMS(Z_Construct_UClass_AOnlineGameMode_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineGameMode_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AOnlineGameMode, 2724579363);
	template<> GAMEFRWKSESSIONSPLUGIN_API UClass* StaticClass<AOnlineGameMode>()
	{
		return AOnlineGameMode::StaticClass();
	}
