...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_ALobbyGameMode_Statics::NewProp_MaxNumberOfPlayers = { "MaxNumberOfPlayers", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALobbyGameMode, MaxNumberOfPlayers), METADATA_PARAMS(Z_Construct_UClass_ALobbyGameMode_Statics::NewProp_MaxNumberOfPlayers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALobbyGameMode_Statics::NewProp_MaxNumberOfPlayers_MetaData)) };
	...
	IMPLEMENT_CLASS(ALobbyGameMode, 420182220);
	template<> GAMEFRWKSESSIONSPLUGIN_API UClass* StaticClass<ALobbyGameMode>()
	{
		return ALobbyGameMode::StaticClass();
	}
